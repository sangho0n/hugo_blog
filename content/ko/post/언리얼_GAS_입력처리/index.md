...
![ability_task.png](img%2Fability_task.png)
...
- 게임플레이 어빌리티 블루프린트 생성
![bp_tags.png](img%2Fbp_tags.png)


- 캐릭터에서 어빌리티 클래스를 cpp에서 블루프린트로 변경
![bp_character.png](img%2Fbp_character.png)
